...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('lflb_story_lflb_sub_category', function (Blueprint $table) {
            $table->foreign(['lflb_sub_category_id'], 'FK_lflb_story_lflb_sub_category_lflb_sub_categories')->references(['id'])->on('lflb_sub_categories')->onUpdate('CASCADE')->onDelete('SET NULL');
