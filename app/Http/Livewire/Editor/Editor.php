...
class Editor extends Component
{
    ...
    {
        $newAsset = $this->makeBlankAsset()->setConnection('mysql');
        $this->storyAssets->add($newAsset);
        $this->save();
    ...
    public function create()
    {
        ...
        // dd($this->story->lflbAssets()->count());
    }
    ...
    {
        // $this->storyAssets->forget($id);
        // dd($this->storyAssets->keyBy('id')->get($id));
        LflbAsset::find($id)->delete();
        $this->emit('refreshAssets');
    }
