                    ...
                    <x-table.row wire:loading.class.delay="opacity-50" wire:key="row-{{ $category->id }}">
                        ...
                        <x-table.cell>
                            <x-button.secondary wire:click="edit({{ $category->id }})">Details</x-button.link>
                                <a href="https://staging.lflbsign.webfoundry.dev/preview?url={{'topics/'.$category->id}}"
                                    target="_blank">
                                    <x-button.secondary>
                                        Preview
                                    </x-button.secondary>
                        ...
                        <x-table.cell>
                            <div class="flex flex-wrap content-center justify-center">
                                <div class="w-96 sm:w-96">
                                    ...
                                    @else
                                    <img src="https://lflbsign.webfoundry.dev/assets/{{ $category->mainImage }}"
                                        alt="..."
                        ...
                        <span class="overflow-hidden w-96 max-h-72">
                            ...
                            <div class="flex flex-wrap content-center justify-center">
                                <div class="w-96 sm:w-96">
                                    ...
                                    @else
                                    <img src="https://lflbsign.webfoundry.dev/assets/{{ $editing->mainImage }}"
                                        alt="..."
                                        class="object-contain h-auto max-w-full align-middle border-none rounded shadow " />
                                    @endif
                                </div>
